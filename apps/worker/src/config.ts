...
const envSchema = z.object({
  ...
  ANTHROPIC_MODEL_PRIMARY: z.string().default("claude-opus-5"),
  ANTHROPIC_MODEL_FALLBACK: z.string().default("claude-sonnet-5"),
  OPENAI_API_KEY: z.string().optional(),
  OPENAI_MODEL_PRIMARY: z.string().default("gpt-5"),
  OPENAI_MODEL_FALLBACK: z.string().default("gpt-5-mini"),
  GEMINI_API_KEY: z.string().optional(),
  GEMINI_MODEL_PRIMARY: z.string().default("gemini-3-flash"),
  GEMINI_MODEL_FALLBACK: z.string().default("gemini-3.1-pro-low"),
